...
<div class="container mt-4" style="width: 720px">
		<% 
			...
			quantity = (quantity.equals("null"))?"":quantity;
		...
		%>
		<form class="row" novalidate action="dang-nhap" method="post">
			 <div class="form-group">
			    <label for="quantity" class="form-label">Số lượng:<span class="rq">*</span></label>
			    <input type="text" class="form-control" id="quantity" value="<%=quantity%>" name="quantity"  required>
			    <div class="rq"><%=e_quantity%></div>
			 </div>
			 <div class="form-group">
